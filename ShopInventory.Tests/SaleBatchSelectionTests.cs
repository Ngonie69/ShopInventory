...
{
    // Today rather than a literal: the till pass only picks up sales inside
    // DesktopSalePostingSettings.LookbackDays (3), so a fixed date silently stops being posted.
