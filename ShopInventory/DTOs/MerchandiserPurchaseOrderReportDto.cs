...
public sealed class MerchandiserPurchaseOrderReportDto
{
    ...
    public List<MerchandiserPurchaseOrderReportMerchandiserDto> Merchandisers { get; init; } = new();
    public List<MerchandiserPurchaseOrderReportOrderDto> Orders { get; init; } = new();
}