    ...
    : IRequestHandler<GetVanSalesInvoicesQuery, ErrorOr<VanSalesInvoicesResult>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // Rep and search narrow the period; the state counts are taken after them and before the state filter,
        // so each count says what choosing that state would show.
        var rows = records
            .Select(r => r.Row)
