...
public class SAPGoodsReceiptPurchaseOrder
{
    ...
    public List<SAPGoodsReceiptPurchaseOrderLine>? DocumentLines { get; set; }
}

public class SAPGoodsReceiptPurchaseOrderLine
{
