...
/// <summary>
/// Queue of invoices whose fiscal status is not yet known locally and has to be read back from the
...
/// <c>GetPagedInvoicesQuery</c>, one round trip per invoice, in sequence — on 2026-08-02 a
