...
public partial class PurchaseQuotations
{
    ...
    private string RegisterCountText => quotationResponse is null
        ? "Not loaded"
        : $"{CurrentPageCount:N0} of {quotationResponse.TotalCount:N0}";
    ...
    private string PageRangeText
    {
        get
        {
            ...
            return $"Showing {start:N0}–{start + CurrentPageCount - 1:N0} of {quotationResponse?.TotalCount ?? CurrentPageCount:N0}";
        }
    }
    ...
    private void CloseDetail() => selectedQuotation = null;
